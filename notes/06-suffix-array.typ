...
#box(
  ...
  *Example:*
  ...
  Sorted suffixes:
  - $i=0$: "a"
  - $i=1$: "ana" (LCP with "a" is 1) $arrow.r$ $L[1]=1$
  - $i=2$: "anana" (LCP with "ana" is 3) $arrow.r$ $L[2]=3$
  - $i=3$: "banana" (LCP with "anana" is 0) $arrow.r$ $L[3]=0$
  - $i=4$: "na" (LCP with "banana" is 0) $arrow.r$ $L[4]=0$
  - $i=5$: "nana" (LCP with "na" is 2) $arrow.r$ $L[5]=2$
...
3. Given the $"SA"$ and $"ISA"$, construct the LCP array ($"LCP"$) for $T = "abracadabra"$.
...
- $i=0$: "a"
- $i=1$: "abra" (LCP with "a" is 1) $arrow.r$ $"LCP"[1]=1$
- $i=2$: "anana" (LCP with "ana" is 3) $arrow.r$ $"LCP"[2]=3$
- $i=3$: "banana" (LCP with "anana" is 0) $arrow.r$ $"LCP"[3]=0$
- $i=4$: "na" (LCP with "banana" is 0) $arrow.r$ $"LCP"[4]=0$
- $i=5$: "nana" (LCP with "na" is 2) $arrow.r$ $"LCP"[5]=2$
- $i=6$: "bracadabra" (LCP with "bra" is 3) $arrow.r$ $"LCP"[6]=3$
- $i=7$: "cadabra" (LCP with "bracadabra" is 0) $arrow.r$ $"LCP"[7]=0$
- $i=8$: "dabra" (LCP with "cadabra" is 0) $arrow.r$ $"LCP"[8]=0$
- $i=9$: "ra" (LCP with "dabra" is 0) $arrow.r$ $"LCP"[9]=0$
- $i=10$: "racadabra" (LCP with "ra" is 2) $arrow.r$ $"LCP"[10]=2$
