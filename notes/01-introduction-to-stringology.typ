...
#info_box(title: "Basic Concepts")[
  / *Alphabet*:
    A set of characters, like ${A, B, C}$ or ${0, 1}$.
  / *String*:
    A sequence of characters from an alphabet.
    / The *empty string* ($epsilon$):
      Has no characters.
    / The *length* of a string:
      Is its number of characters (e.g., $|"\"hello\""| = 5$).
  / *Parts of a String*:
    / *Prefix*:
      The beginning of a string (e.g., `"he"` in `"hello"`).
    / *Suffix*:
      The end of a string (e.g., `"llo"` in `"hello"`).
    / *Substring*:
